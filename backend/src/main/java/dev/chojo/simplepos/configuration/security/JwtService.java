...
public class JwtService {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails, Map<String, Object> claims) {
        if (!userDetails.getUsername().equals(extractUsername(token))) return false;
